...
public class ClerkJwksProvider {
    ...
    private long lastFetchetime = 0;
    private static final long cacheTtl = 360000;

    public PublicKey getPublicKey(String kid) throws Exception {
        if (keyCache.containsKey(kid) &&
                System.currentTimeMillis() - lastFetchetime < cacheTtl) {
    ...
    private void refreshKeys() throws Exception {
        ...
        lastFetchetime = System.currentTimeMillis();
    }
